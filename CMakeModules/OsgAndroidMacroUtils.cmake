...
MACRO(ANDROID_3RD_PARTY)
    ...
    if(JPEG_INCLUDE_DIR)
        ...
        set(JPEG_FOUND "Yes")
        install(DIRECTORY 3rdparty/build/libjpeg/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    ...
    if(PNG_INCLUDE_DIR)
        ...
        set(PNG_FOUND "Yes")
        install(DIRECTORY 3rdparty/build/libpng/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    ...
    if(GIFLIB_INCLUDE_DIR)
        ...
        install(DIRECTORY 3rdparty/build/giflib/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    ...
    if(TIFF_INCLUDE_DIR)
        ...
        set(TIFF_FOUND "Yes")
        install(DIRECTORY 3rdparty/build/libtiff/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    ...
    #    set(ZLIB_FOUND "Yes")
    #    install(DIRECTORY 3rdparty/build/zlib/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    ...
    if(CURL_DIR)
        ...
        set(CURL_FOUND "Yes")
        install(DIRECTORY 3rdparty/build/curl/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    else(CURL_DIR)
    ...
    if(FREETYPE_DIR)
        ...
        install(DIRECTORY 3rdparty/build/freetype/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    else(FREETYPE_DIR)
    ...
    if(GDAL_DIR)
        ...
        set(GDAL_FOUND "Yes")
        install(DIRECTORY 3rdparty/build/gdal/obj/local/${ANDROID_ABI}/ DESTINATION ./lib )
    else(GDAL_DIR)
